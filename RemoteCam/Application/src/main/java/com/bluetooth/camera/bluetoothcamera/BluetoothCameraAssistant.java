...
public class BluetoothCameraAssistant implements ActionInterface {
    ...
    public BluetoothCameraAssistant(Context context, Handler handler) {
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            Log.e(TAG, "Accept thread: " + mSocketType +
            ...
            while (mState != STATE_CONNECTED) {
                ...
                if (socket != null) {
                    synchronized (BluetoothCameraAssistant.this) {
                        switch (mState) {
                            case STATE_LISTEN:
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            int bytes;
            /*mHandler.obtainMessage(AppConstants.START_CAMERA_SERVICE,0, -1,0)
                    .sendToTarget();*/
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(AppConstants.CAMERA_PREVIEW, bytes, -1, buffer)
                            .sendToTarget();
